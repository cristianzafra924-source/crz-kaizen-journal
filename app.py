  ...
  <span style="font-size:10px;color:#475569;margin-left:auto;">{_utc_str}</span>
    ...
    with _col_right:
        ...
        _panel_html = (
            ...
            '#sec-x{width:100%;flex:1;border:none;background:#15202b;display:none}'
            '</style>'
            '</head><body>'
            ...
            '<iframe id="sec-x"></iframe>'
            '<div class="feed" id="sec-t" style="display:none;"></div>'
            '<script>'
            'var TW_SRC=' + repr(_tw_src) + ';'
            'var CHS='   + _ch_json    + ';'
            'var NEWS='  + _news_json  + ';'
            'var TRUMP=' + _trump_json + ';'
            'var CUR="",ACTIVE_FEED=NEWS,TW_LOADED=false;'
            ...
            '  if(s==="x"){var f=document.getElementById("sec-x");f.style.display="block";if(!TW_LOADED){f.src=TW_SRC;TW_LOADED=true;}}'
