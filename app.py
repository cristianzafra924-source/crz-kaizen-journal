  ...
  <span style="font-size:10px;color:#475569;margin-left:auto;">{_utc_str}</span>
    ...
    with _col_right:
        ...
        _panel_html = (
            ...
            '  <iframe id="tw-frame" src="" width="100%" height="100%" frameborder="0" '
            '    style="background:#060d1a;border:none;width:100%;height:100%"></iframe>'
            '</div>'
            '<script>'
            'var CHS=' + _ch_json + ';'
            'var KW={'
            ...
            '  document.getElementById("sec-tw").style.display=isNews?"none":"block";'
            ...
            '      "https://syndication.twitter.com/srv/timeline-profile/screen-name/realDonaldTrump'
            '?dnt=true&theme=dark&chrome=noheader%20nofooter%20noborders%20transparent";'
            '    _twLoaded=true;'
            '  }'
            '}'
            # News feed via allorigins CORS proxy
            'var feedEl=document.getElementById("sec-news");'
            'var newsUrl="https://news.google.com/rss/search?q=war+conflict+ukraine+israel+iran+military+sanctions&hl=en&gl=US&ceid=US:en";'
            ...
            '    var src=it.querySelector("source")?it.querySelector("source").textContent:"";'
            '    var pub=it.querySelector("pubDate")?it.querySelector("pubDate").textContent:"";'
            '    var c=getC(title),tm=ago(pub);'
